...
public class _02_isDisplayed extends BaseDriver {
    ...
    public void Test1(){
        ...
        //System.out.println((hiddenObj.isDisplayed())); // BURASI DEĞİŞTİ 1
        Assert.assertFalse("Email girmeden önce gizli değil.",hiddenObj.isDisplayed());
        ...
        //System.out.println(hiddenObj.isDisplayed()); //BURASI DEĞİŞTİ 2
        Assert.assertTrue("Email girişi yapılınca ortaya çıkmadı",hiddenObj.isDisplayed());
